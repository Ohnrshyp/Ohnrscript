 ...
 *
 * @param {Buffer} buffer - The raw TCP chunk representing the WS frame.
 * @returns {Object|null} Pointers to the unmasked payload and frame metadata.
 */
function parseFrame(buffer) {
  ...
  return { fin, opcode, payloadStart, payloadLength };
}

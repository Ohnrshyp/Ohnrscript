...
console.log("Benchmarking Standard Zod + cbor-x vs Ohnrscript AOT CBOR over millions of iterations...");
const ITERATIONS = 1_000_000; // Scaled to millions
...
// Ohnrscript mathematically proves to bypass V8 GC with near-zero heap delta and drastically faster execution time.
